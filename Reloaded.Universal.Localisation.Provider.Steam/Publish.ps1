...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Reloaded.Universal.Localisation.Provider.Steam.csproj",
    $PackageName = "Reloaded.Universal.Localisation.Provider.Steam",
    ...
    $NuGetPackageId = "Reloaded.Universal.Localisation.Provider.Steam",
