...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Reloaded.Universal.Localisation.Provider.Windows.csproj",
    $PackageName = "Reloaded.Universal.Localisation.Provider.Windows",
    ...
    $NuGetPackageId = "Reloaded.Universal.Localisation.Provider.Windows",
