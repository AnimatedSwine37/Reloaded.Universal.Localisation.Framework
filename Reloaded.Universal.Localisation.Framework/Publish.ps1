...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Reloaded.Universal.Localisation.Framework.csproj",
    $PackageName = "Reloaded.Universal.Localisation.Framework",
    ...
    $NuGetPackageId = "Reloaded.Universal.Localisation.Framework",
